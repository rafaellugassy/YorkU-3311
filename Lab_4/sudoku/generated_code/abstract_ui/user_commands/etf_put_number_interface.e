...
feature {NONE} -- Initialization
	...
	make(an_etf_cmd_name: STRING; etf_cmd_args: TUPLE; an_etf_cmd_container: ETF_ABSTRACT_UI_INTERFACE)
		do
			...
			etf_cmd_routine := agent put_number(? , ? , ?)
			...
			then
				out := "put_number(" + etf_event_argument_out("put_number", "num", num) + "," + etf_event_argument_out("put_number", "row", row) + "," + etf_event_argument_out("put_number", "col", col) + ")"
			else
				etf_cmd_error := True
			end
		end
